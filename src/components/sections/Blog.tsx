            ...
            >
              <div className="relative h-48 sm:h-52 overflow-hidden">
                <div className="absolute top-4 left-4 z-10">
                  <span className="bg-[#b38f07] text-white text-xs font-bold px-3 py-1.5 rounded-full uppercase tracking-wider shadow-sm">
                    {post.category}
                  </span>
                </div>
                <img
              ...
              <CardHeader className="p-5 sm:p-6 pb-4">
                <div className="flex items-center text-xs sm:text-sm text-slate-500 mb-3 font-medium">
                  <CalendarDays className="w-4 h-4 mr-2 text-[#b38f07]" />
                  {post.date}
                </div>
                <CardTitle className="text-lg sm:text-xl leading-tight group-hover:text-[#b38f07] transition-colors">
                  {post.title}
                </CardTitle>
              </CardHeader>
              <CardContent className="p-5 sm:p-6 pt-0 flex-1 flex flex-col justify-between">
                <CardDescription className="text-sm sm:text-base text-slate-600 mb-6 line-clamp-3">
                  {post.excerpt}
                </CardDescription>
                <a
                  href="#blog"
